...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyApp.Domain.Entities.ChatMessage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("MyApp.Domain.Entities.ChatSession", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("MyApp.Domain.Entities.ChatMessage", b =>
                {
                    b.HasOne("MyApp.Domain.Entities.User", "Sender")
                        .WithMany()
                        .HasForeignKey("SenderId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("MyApp.Domain.Entities.ChatSession", "Session")
                        .WithMany("Messages")
            ...
            modelBuilder.Entity("MyApp.Domain.Entities.ChatSession", b =>
                {
                    b.HasOne("MyApp.Domain.Entities.User", "AssignedAdmin")
                        .WithMany()
