            ...
            <Card
              ...
              actions={
                <button
                  ...
                  className="inline-flex items-center rounded-xl border border-slate-700/70 bg-slate-900/60 px-2 py-1 text-[11px] text-slate-200 hover:border-brand-500/60 hover:text-brand-200"
                >
                  <span className="mr-1">{isOpen ? 'Hide menu' : 'View menu'}</span>
                  {isOpen ? (
                  ...
                  <div className="space-y-4 text-xs text-slate-300">
                    {pkg.sections.map((section) => (
                      <div key={section.title}>
                        <p className="font-semibold text-slate-100 mb-1">{section.title}:</p>
